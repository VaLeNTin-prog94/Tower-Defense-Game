...
class Settings:
    ...
    def __init__(self):
        ...
        self.enemy_paths = [
            ...
            [(50, 600), (200, 600), (200, 400), (500, 400),
             (500, 700), (800, 700), (800, 500), (1150, 500)],

            # Путь 3 (другой вариант)
            [(50, 300), (250, 300), (250, 500), (550, 500),
             (550, 250), (850, 250), (850, 400), (1150, 400)]
        ]
        # Выбираем случайный путь при запуске
